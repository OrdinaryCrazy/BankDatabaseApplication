...
CREATE TABLE CUSTOMER (
    CUSTOMER_ID                 DECIMAL(16) CONSTRAINT CUSTOMER_PK PRIMARY KEY,
    CUSTOMER_NAME               CHAR(32),
    CUSTOMER_PHONE              DECIMAL(12),
    CUSTOMER_ADDRESS            CHAR(128),
    CUSTOMER_CONTACT_NAME       CHAR(32),
    CUSTOMER_CONTACT_PHONE      DECIMAL(12),
...
CREATE TABLE CHECK_ACCOUNT (
    CHECK_ACCOUNT_ID            DECIMAL(16) CONSTRAINT CHECK_ACCOUNT_PK PRIMARY KEY,
...
CREATE TABLE DEPOSIT_ACCOUNT (
    DEPOSIT_ACCOUNT_ID              DECIMAL(16) CONSTRAINT DEPOSIT_ACCOUNT_PK PRIMARY KEY,
...
CREATE TABLE CUSTOMER_DEPOSIT_ACCOUNT (
    ...
    CUSTOMER_ID         DECIMAL(16),     /* CONSTRAINT CD_CUSTOMER_ID   PRIMARY KEY, */
    DEPOSIT_ACCOUNT_ID  DECIMAL(16),
    LAST_VIEW           DATE,
...
CREATE TABLE CUSTOMER_CHECK_ACCOUNT (
    ...
    CUSTOMER_ID         DECIMAL(16),     /* CONSTRAINT CC_CUSTOMER_ID   PRIMARY KEY, */
    CHECK_ACCOUNT_ID    DECIMAL(16),
    LAST_VIEW           DATE,
...
CREATE TABLE LOAN_CUSTOMER (
    CUSTOMER_ID DECIMAL(16), /* CONSTRAINT LC_CUSTOMER_ID_PK    PRIMARY KEY, */
...
CREATE TABLE EMPLOYEE_CUSTOMER (
    CUSTOMER_ID DECIMAL(16), /* CONSTRAINT EC_CUSTOMER_ID_PK    PRIMARY KEY, */
    EMPLOYEE_ID DECIMAL(16), /* CONSTRAINT EC_EMPLOYEE_ID_PK    PRIMARY KEY, */
    SERVICETYPE CHAR(16),
