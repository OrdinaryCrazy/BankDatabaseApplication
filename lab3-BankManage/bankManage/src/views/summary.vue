<template>
  <div v-loading="loading">
    ...
    <form align="left" onSubmit="return false" >
        ...
        <button class="button" v-on:click="start()"> <span>提交</span> </button>
    </form>   
...
export default {
  ...
  methods: {
    start: function () {
        ...
        this.$http.post('http://' + document.domain + ':5000/summary', {
